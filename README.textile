...
bc. compile group: 'org.corejet', name: 'corejet-junit-runner', version:'0.28'
...
9. Migrate your stories into test classes. This can be done using the "CoreJet-JIRA-Chrome-plugin":https://github.com/corejet/CoreJet-JIRA-Chrome-plugin examples can be seen in SimpleBddTest.java.
...
bc. build.runAfter generateHtmlReport
